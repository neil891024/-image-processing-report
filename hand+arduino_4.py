#判斷手勢控制LED動作(電燈全開、全關、單獨開關電燈)
#增加判斷精度 使用陣列宣告hand_flag 
#副函式順序 hand_angle
import cv2
...
with mp_hands.Hands( 
    ...
    hand_flag = [0,0,0,0,0,0,0,0] #宣告hand_flag
    hand_delay = 15 #手勢的判斷時間
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                if finger_points:
                    ...
                    if hand_flag[0] == hand_delay: #判讀時間約15秒
                        hand_flag[0]= 0
